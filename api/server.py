...
# Connect to Database
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("POSTGRES", "postgresql://default:************@ep-little-bush-52709451.us-east-1.postgres.vercel-storage.com:5432/verceldb")
